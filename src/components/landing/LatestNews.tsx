...
export default function LatestNews() {
    ...
    const latestNews = useMemo(() => items, [items]);
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
                    {loading ? (
                        ...
                        <p className="text-center text-gray-500 col-span-full">{t('noNews')}</p>
                    ) : latestNews.map((item) => {
                        const category = NEWS_CATEGORIES[item.category as NewsCategoryKey] || NEWS_CATEGORIES.other;
                            ...
                            >
                                ...
                                {item.imageUrl && (
                                    <div className="relative h-56 bg-gray-200 overflow-hidden">
                                        ...
                                        {/* Video Badge */}
                                        {item.videoUrl && (
                                            <div className="absolute top-4 right-4 bg-red-600/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
                                                <span>▶</span>
