...
export default function TrainingContent() {
    ...
    return (
        <div className="space-y-8">
            <div className="bg-gradient-to-br from-green-50/80 to-white pb-2 pt-8 border-b border-gray-100 rounded-t-3xl">
            ...
            <div className="w-full max-w-7xl mx-auto animate-fade-in min-h-[600px] px-4">
                {activeTab === 'programs' && (
                        ...
                        {programs.map((program, index) => (
                            <div key={index} className={`bg-white p-8 rounded-2xl shadow-sm border border-${program.color}-100 hover:shadow-lg hover:border-${program.color}-300 transition-all group`}>
                                <div className="flex flex-col md:flex-row items-start gap-8">
                                    <div className={`bg-${program.color}-50 p-[1.875rem] rounded-2xl group-hover:scale-110 transition-transform duration-300 text-${program.color}-600`}>
                                        <program.icon className="w-8 h-8 md:w-10 md:h-10" />
                                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {formats.map((format, index) => (
                            <div key={index} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md hover:-translate-y-1 transition-all">
                                <div className="bg-gray-50 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 text-gray-600">
                                    <format.icon className="w-8 h-8 md:w-9 md:h-9" />
                                </div>
